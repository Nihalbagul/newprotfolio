    ...
    <div className="theme-switch-wrapper">
      ...
      <style>{`
        ...
        .theme-switch {
          ...
          --circle-transition: 1.8s cubic-bezier(0.4, 0, 0.2, 1);
        }
        ...
        .theme-switch__circle-container {
          ...
          display: -ms-flexbox;
          display: flex;
          -webkit-transition: left var(--circle-transition);
          -o-transition: left var(--circle-transition);
        ...
        .theme-switch__clouds {
          ...
          -o-transition: bottom 2s cubic-bezier(0.4, 0, 0.2, 1);
